...
def AsignarRuta(campers, Ruta):
    while True:
        ...
        if cc in campers:
            print("Seleccione la ruta a asignar:\n\t1. NodeJS\n\t2. Java\n\t3. NetCore")
            selec = manejoINT()
    ...
    while True:
        ...
        if cc in campers:
            if 'notas de filtro' in campers[cc]:
                ...
                elif selec == 3: campers[cc]['notas de filtro'] = {'Programacion formal': notas.get('Programacion formal', {})}
                elif selec == 4: campers[cc]['notas de filtro'] = {'Bases de datos': notas.get('Bases de datos', {})}
                elif selec == 5: campers[cc]['notas de filtro'] = {'Backend': notas.get('Backend', {})}
            else:
    ...
    while True:
        ...
        if cc in campers:
            if 'inscrito' in campers[cc].values():
                print("Ingrese el día de ingreso:")
                dia = manejoINT()
                print("Ingrese el mes de ingreso:")
                mes = manejoINT()
                print("Ingrese el año de ingreso:")
                annio = manejoINT()
                print("Ingrese el día esperado de finalización:")
                diaF = manejoINT()
                print("Ingrese el mes esperado de finalización:")
                mesF = manejoINT()
                print("Ingrese el año esperado de finalización:")
                annioF = manejoINT()
